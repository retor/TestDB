 ...
 */
class DBHelper(val context: Context, name: String?= ListProvider.LIST_TABLE, factory: ((SQLiteDatabase, SQLiteCursorDriver, String, SQLiteQuery) -> Cursor)?=null, version: Int=1) :
